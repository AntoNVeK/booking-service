...
@NoArgsConstructor
@AllArgsConstructor
public class BookingToCreate {

    @NotNull(message = "Дата начала брони обязательна")
    @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss")
    @Schema(description = "Дата и время начала брони", example = "2026-03-01T14:00:00")
    private LocalDateTime dateStart;

    @NotNull(message = "Дата окончания брони обязательна")
    @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss")
    @Schema(description = "Дата и время окончания брони", example = "2026-03-05T12:00:00")
